		...
		<div class="row">
			...
			<div class="panel panel-primary">
				<!-- TITLE -->
		  		...
		  		<!-- FOOTER-->
		  		<div class="panel-footer" style="background-color:#0073e6;">
						<span class="col-sm-2">
			  			...
			  			<?php
							...
							if(isset($_SESSION['username']) ) {
								if($_SESSION['username']==$author || $_SESSION['usertype']=='admin') {
									...
									<a href='update.php?id=$id'  type=\"button\" class=\"btn btn-sm btn-success\">
										<i class=\"glyphicon glyphicon-edit\"></i>
									</a>

									<a href=$delete_post_link type=\"button\" class=\"btn btn-sm btn-danger\">
